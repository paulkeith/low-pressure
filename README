...
This is a theme for [Hugo](https://gohugo.io/) that has very few features but is quick, responsive and doesn't use javascript.  It's partly inspired by [Idle Words](https://idlewords.com/).
